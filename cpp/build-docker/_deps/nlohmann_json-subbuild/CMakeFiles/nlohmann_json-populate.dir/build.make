...
CMAKE_SOURCE_DIR = /app/build/_deps/nlohmann_json-subbuild

# The top-level build directory on which CMake was run.
CMAKE_BINARY_DIR = /app/build/_deps/nlohmann_json-subbuild
...
CMakeFiles/nlohmann_json-populate-complete: nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-test
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/build/_deps/nlohmann_json-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Completed 'nlohmann_json-populate'"
	/usr/bin/cmake -E make_directory /app/build/_deps/nlohmann_json-subbuild/CMakeFiles
	/usr/bin/cmake -E touch /app/build/_deps/nlohmann_json-subbuild/CMakeFiles/nlohmann_json-populate-complete
	/usr/bin/cmake -E touch /app/build/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-done
...
nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-build: nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-configure
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/build/_deps/nlohmann_json-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "No build step for 'nlohmann_json-populate'"
	cd /app/build/_deps/nlohmann_json-build && /usr/bin/cmake -E echo_append
	cd /app/build/_deps/nlohmann_json-build && /usr/bin/cmake -E touch /app/build/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-build
...
nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-configure: nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-patch
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/build/_deps/nlohmann_json-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "No configure step for 'nlohmann_json-populate'"
	cd /app/build/_deps/nlohmann_json-build && /usr/bin/cmake -E echo_append
	cd /app/build/_deps/nlohmann_json-build && /usr/bin/cmake -E touch /app/build/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-configure

nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-download: nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-source_dirinfo.txt
nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-download: nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-mkdir
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/build/_deps/nlohmann_json-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_4) "No download step for 'nlohmann_json-populate'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /app/build/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-download
...
nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-install: nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-build
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/build/_deps/nlohmann_json-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_5) "No install step for 'nlohmann_json-populate'"
	cd /app/build/_deps/nlohmann_json-build && /usr/bin/cmake -E echo_append
	cd /app/build/_deps/nlohmann_json-build && /usr/bin/cmake -E touch /app/build/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-install

nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-mkdir:
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/build/_deps/nlohmann_json-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_6) "Creating directories for 'nlohmann_json-populate'"
	/usr/bin/cmake -Dcfgdir= -P /app/build/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/tmp/nlohmann_json-populate-mkdirs.cmake
	/usr/bin/cmake -E touch /app/build/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-mkdir
...
nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-patch: nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-update
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/build/_deps/nlohmann_json-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_7) "No patch step for 'nlohmann_json-populate'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /app/build/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-patch
...
nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-test: nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-install
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/build/_deps/nlohmann_json-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_8) "No test step for 'nlohmann_json-populate'"
	cd /app/build/_deps/nlohmann_json-build && /usr/bin/cmake -E echo_append
	cd /app/build/_deps/nlohmann_json-build && /usr/bin/cmake -E touch /app/build/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-test
...
nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-update: nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-download
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/build/_deps/nlohmann_json-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_9) "No update step for 'nlohmann_json-populate'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /app/build/_deps/nlohmann_json-subbuild/nlohmann_json-populate-prefix/src/nlohmann_json-populate-stamp/nlohmann_json-populate-update
...
CMakeFiles/nlohmann_json-populate.dir/depend:
	cd /app/build/_deps/nlohmann_json-subbuild && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /app/build/_deps/nlohmann_json-subbuild /app/build/_deps/nlohmann_json-subbuild /app/build/_deps/nlohmann_json-subbuild /app/build/_deps/nlohmann_json-subbuild /app/build/_deps/nlohmann_json-subbuild/CMakeFiles/nlohmann_json-populate.dir/DependInfo.cmake "--color=$(COLOR)"
